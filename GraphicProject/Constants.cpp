...
const std::string Constants::BUTTON_CONVERT_TO_BMP_AND_SAVE = "convert to bmp and save";
const std::string Constants::BUTTON_SHOW_OX = "show ox";
const std::string Constants::EXCEPTION_TOO_SMALL_SURFACE = "too small surface, press esc to back to main menu";
const std::string Constants::WRONG_FILE_EXTENSION = "wrong file extension choose another file";
